...
(function run() {
  ...
  const militaryAirport = new Airport(airport.militaryPlanes);
  const passengerAirport = new Airport(airport.passengerPlanes);
  ...
  console.log(`Plane with max passenger capacity: ${Airport.print(passengerAirport.passengerPlaneWithMaxPassengersCapacity)}`);
})();
